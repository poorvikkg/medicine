      ...
      <div className="auth-card" style={{ maxWidth: 480 }}>
        <div style={{ textAlign: 'center', marginBottom: 26 }}>
          <div style={{
            ...
            <span style={{ fontSize: 22, color: 'var(--clr-primary)', fontWeight: 'bold' }}>+</span>
          </div>
          <div style={{
          ...
          <h1 style={{ fontSize: '1.6rem', fontWeight: 600, margin: '0 0 4px 0' }}>Create Account</h1>
          <p style={{ color: 'var(--clr-muted)', margin: 0 }}>Join to manage your medication schedule.</p>
        </div>
          ...
          <div className="form-group">
            ...
            <div style={{ position: 'relative' }}>
              <input id="reg-password" name="password"
                ...
                onChange={handleChange} required style={{ paddingRight: 40 }} />
              <button type="button" onClick={() => setShowPass(!showPass)}
                style={{
                  position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)',
                  background: 'none', border: 'none', cursor: 'pointer',
                  color: 'var(--clr-muted)', display: 'flex', padding: 0,
                }}>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, color: 'var(--clr-muted)', fontSize: '0.95rem' }}>
          Already have an account?{' '}
          <Link href="/login" style={{ color: 'var(--clr-primary)', fontWeight: 600, textDecoration: 'underline' }}>Sign In</Link>
        </p>
      </div>
    </div>
  );
